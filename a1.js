// a1.js – Approach 1: 1 Client → Load Balancer (port 4000) → Multiple Servers
...
export default function () {
    ...
    // Targeting the load balancer endpoint on port 4000
...
export function handleSummary(data) {
    return {
        // This file (report_a1.html) will be written in your working directory
        "report_a1.html": htmlReport(data, { title: "K6 Load Test Report - Approach 1" }),
